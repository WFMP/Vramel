...
public class RabbitMQConsumer extends DefaultConsumer {
    ...
    protected void doStart() throws Exception {
        ...
        try {
            ...
            logger.info("Connection failed, will start background thread to retry!", e);
    ...
    protected void doStop() throws Exception {
        ...
        if (executor != null) {
            if (endpoint != null && endpoint.getVramelContext() != null) {
                endpoint.getVramelContext().getExecutorServiceManager().shutdownNow(executor);
            } else {
    ...
    class RabbitConsumer extends com.rabbitmq.client.DefaultConsumer {
        ...
        public void handleDelivery(String consumerTag, Envelope envelope,
            ...
            logger.trace("Created exchange [exchange={}]", exchange);
            ...
            if (!exchange.isFailed()) {
                ...
                if (!consumer.endpoint.isAutoAck()) {
                    logger.trace("Acknowledging receipt [delivery_tag={}]", deliveryTag);
        ...
        public Void call() throws Exception {
            ...
            while (running.get() && connectionFailed) {
                try {
                    ...
                    logger.info("Connection failed, will retry in " + connectionRetryInterval + "ms", e);
